...
def main():
    ...
    dataset_yaml_path = '/home/juandomingo/factoriaf5/mod03-projs/G3-COMPUTER-VISION/data/datasets/curated/dataset_v1_yolov8m/data.yaml'

    # Parámetros de entrenamiento
    epochs = 50
    project_folder = 'training_results'
    run_name = 'yolov8m_full_dataset_50_epochs_py'
